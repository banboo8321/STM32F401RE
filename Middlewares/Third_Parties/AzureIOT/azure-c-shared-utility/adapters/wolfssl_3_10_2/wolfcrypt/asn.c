...
CPU_signed longS NetSecure_ValidateDateHandler(CPU_INT08U *date, CPU_INT08U format,
                                         CPU_INT08U dateType)
{
    CPU_BOOLEAN  rtn_code;
    CPU_signed longS   i;
    CPU_signed longS   val;
    CPU_signed shortU   year;
    CPU_INT08U   month;
    CPU_signed shortU   day;
    CPU_INT08U   hour;
    CPU_INT08U   min;
    CPU_INT08U   sec;
